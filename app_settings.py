...
class Settings:
    ...
    def apply_to_session_state(self, session_state: Any) -> None:
        ...
        session_state["stock_pct"] = int(round(self.stock_pct * 100))
        session_state["target_success_rate"] = int(round(self.target_success_rate * 100))
        ...
        session_state["upper_guardrail_success"] = int(round(self.upper_guardrail_success * 100))
        session_state["lower_guardrail_success"] = int(round(self.lower_guardrail_success * 100))
        session_state["upper_adjustment_fraction"] = int(round(self.upper_adjustment_fraction * 100))
        session_state["lower_adjustment_fraction"] = int(round(self.lower_adjustment_fraction * 100))
        session_state["adjustment_threshold"] = int(round(self.adjustment_threshold * 100))
